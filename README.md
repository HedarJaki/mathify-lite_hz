...
mockups/UML diagram in `design/`, and [AGENTS.md](.agents/AGENTS.md) for
detailed conventions and gotchas when working in this codebase (`CLAUDE.md`
just imports it for Claude Code).
